        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {skillCategories.map((category, idx) => (
              <div
                key={idx}
                className="glass rounded-2xl p-8 border-2 border-white/40 hover:border-white/60 hover:scale-105 transition-all duration-300 hover:shadow-xl"
                style={{
              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {category.skills.map((skill, skillIdx) => (
                    <span
                      key={skillIdx}
                      className="px-4 py-2 bg-gradient-to-r from-purple-400/60 to-pink-300/60 text-slate-800 rounded-full text-sm font-medium border border-white/40 hover:border-white/60 hover:scale-110 transition-all duration-300"
                    >
                      {skill}
                    </span>
                  ))}
