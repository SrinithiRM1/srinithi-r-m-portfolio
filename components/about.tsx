          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div className="space-y-6">
              ...
              <p className="text-lg text-slate-700 leading-relaxed">
                ...
                electronics and layouts. Currently leading the Art Club at VIT Chennai, where I blend creative vision
            ...
            <div className="grid gap-4">
              <div className="glass rounded-2xl p-6 border-2 border-white/40 hover:border-white/60 hover:scale-105 transition-all duration-300 hover:shadow-lg">
